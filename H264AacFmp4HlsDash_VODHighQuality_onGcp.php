...
const TEST_NAME = "h264-aac-fmp4-hls-dash-vod-high-quality";
...
const INPUT_PATH = "{YOUR INPUT FILE PATH";  // "AWOLNATION_muxed.mkv";
...
$video_encoding_profiles = [
    ['height' => 720, 'bitrate' => 2000000, 'profile' => ProfileH264::HIGH(),
        'mode' => StreamMode::STANDARD(), 'preset' => PresetConfiguration::VOD_HIGH_QUALITY()],
