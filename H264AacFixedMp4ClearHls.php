...
const S3_INPUT_ACCESS_KEY="{YOUR S3 BUCKET ACCESS KEY}";
const S3_INPUT_SECRET_KEY="{YOUR S3 BUCKET SECRET KEY}";

const INPUT_PATH = "big_buck_bunny_1080p_h264.mov";

const S3_OUTPUT_BUCKET_NAME="{YOUR OUTPUT S3 BUCKET NAME}";
const S3_OUTPUT_ACCESS_KEY="{YOUR S3 BUCKET ACCESS KEY}";
const S3_OUTPUT_SECRET_KEY="{YOUR S3 BUCKET SECRET KEY}";
