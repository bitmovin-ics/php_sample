...
use BitmovinApiSdk\Models\InfrastructureSettings;
...
const TEST_NAME = "h264-aac-fmp4-hls-dash-vod-standard-cloudconnect";

const BITMOVIN_API_KEY="{YOUR API KEY}";
const BITMOVIN_TENANT_ORG_ID="{YOUR ORG ID}";

const BITMOVIN_INFRASTRUCTURE_ID="{YOUR INFRASTRUCTURE ID}";
